...
export default function PostDetails() {
  let { posts, loading, loadingUserPosts } = useSelector((store) => store.postsReducer);
  ...
  if (loading || loadingUserPosts) return <Loader />;
        ...
        {sortedPosts?.map((post) => (
          <React.Fragment key={post.id}>
            {(post.body || post.image) && (
              <div className="lg:w-6/12 shadow-md rounded-lg overflow-hidden w-11/12 pt-3 m-auto dark:bg-gray-800 dark:text-gray-200 bg-amber-50">
